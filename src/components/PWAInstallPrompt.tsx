...
export default function PWAInstallPrompt(): JSX.Element {
  ...
  return (
    <Show when={showPrompt() && !isStandalone()}>
      <div class="fixed bottom-0 left-0 right-0 z-50 p-4 bg-gradient-to-t from-black/95 to-black/90 backdrop-blur-sm border-t border-green-500/20 shadow-lg animate-slide-up">
        <div class="max-w-2xl mx-auto">
          <div class="flex items-start gap-3">
            ...
            <div class="flex-1 min-w-0">
              <h3 class="text-white font-semibold text-base mb-1">Install SSTV Decoder</h3>
              ...
              {/* iOS Instructions */}
              <Show when={isIOS()}>
                <div class="bg-gray-800/50 rounded-lg p-3 mb-3 text-xs text-gray-300 space-y-1">
                  <p class="font-medium text-white mb-2">To install:</p>
                  <div class="flex items-start gap-2">
                    <span class="text-green-400">1.</span>
                    <p>
                      Tap the Share button{' '}
                      <span class="inline-flex items-center justify-center w-5 h-5 bg-blue-500 rounded text-white text-xs">⬆️</span>
                    </p>
                  </div>
                  <div class="flex items-start gap-2">
              ...
              <div class="flex flex-wrap gap-2">
                <Show when={!isIOS() && deferredPrompt()}>
                  <button
                ...
                <button
                  ...
                  class="px-4 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-lg font-medium text-sm transition-colors"
                >
                  Maybe Later
                </button>

                <button onClick={handleDismiss} class="px-4 py-2 text-gray-400 hover:text-white text-sm transition-colors">
                  Don&apos;t Show Again
                </button>
              </div>
            </div>
            ...
            {/* Close button */}
            <button onClick={handleDismiss} class="flex-shrink-0 text-gray-400 hover:text-white transition-colors" aria-label="Close">
